...
<head>
  ...
  <a href="{{ route('registros') }}">Ir a registros</a>
    ...
    <div class="card shadow-lg rounded-4 overflow-hidden custom-form-card p-4">
      ...
      <form>
        ...
        <div class="mb-4 position-relative input-group-container">
          ...
          <div class="position-relative">
            <input type="password" name="password" id="password2" class="form-control input-border" placeholder="Ingrese su contraseña" />
